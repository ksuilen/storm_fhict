...
class Settings(BaseSettings):
    ...
    STORM_MAX_CONCURRENT_RUNS: int = Field(default=2, env="STORM_MAX_CONCURRENT_RUNS")
    STORM_MAX_CONCURRENT_RUNS_PER_VOUCHER: int = Field(default=1, env="STORM_MAX_CONCURRENT_RUNS_PER_VOUCHER")
